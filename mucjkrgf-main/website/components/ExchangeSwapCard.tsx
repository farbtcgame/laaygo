...
export const ExchangeSwapCard: React.FC = () => {
  ...
  return (
    <div className="border border-zinc-800/80 bg-[#0f1115] p-5 md:p-6 space-y-4 max-w-lg">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-bold text-white tracking-widest uppercase">Swap</h3>
      ...
      <div className="border border-zinc-800 bg-zinc-950 p-4 space-y-2">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <span className="px-3 py-1.5 border border-zinc-800 text-xs font-bold text-[#CCFF00] tracking-wide">
            {fromSymbol}
          </span>
        </div>
      </div>
      ...
      <div className="flex justify-center">
        <button
          type="button"
          onClick={handleFlip}
          className="h-8 w-8 flex items-center justify-center border border-zinc-800 bg-zinc-950 text-zinc-400 hover:text-[#CCFF00] hover:border-[#CCFF00]/50 transition-colors"
