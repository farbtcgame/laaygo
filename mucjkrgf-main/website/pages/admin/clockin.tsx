    ...
    <div className="p-6 border border-zinc-800 bg-[#0f1115] space-y-4">
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className="w-full bg-black border border-zinc-800 p-2.5 text-xs text-white focus:border-[#CCFF00] outline-none"
        />
        {feePreview && (
          <div className="flex justify-between text-[10px] text-zinc-400 p-2 bg-black border border-zinc-900">
      ...
      <button
        ...
        className="w-full py-2.5 bg-[#CCFF00] text-black font-bold text-xs tracking-widest disabled:opacity-30"
      >
    ...
    <Layout>
      ...
      <AdminGuard>
        <div className="space-y-6">
          ...
          <div className="p-6 border border-zinc-800 bg-[#0f1115] space-y-3 text-xs">
          ...
          <div className="p-6 border border-zinc-800 bg-[#0f1115] space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 border border-zinc-800 bg-zinc-950 space-y-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-[#CCFF00] text-black text-xs font-bold disabled:opacity-30"
                >
                  FUND POOL
                </button>
              </div>
              ...
              <div className="p-4 border border-zinc-800 bg-zinc-950 space-y-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-red-900/60 border border-red-800 text-red-200 text-xs font-bold disabled:opacity-30"
                >
                  WITHDRAW
                </button>
              </div>
          ...
          {txState !== "IDLE" && (
            <div className="p-3 text-xs border border-zinc-800 bg-zinc-950 text-zinc-400">
              STATUS: {txState}
