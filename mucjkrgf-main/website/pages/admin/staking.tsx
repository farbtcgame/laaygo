            ...
            <div className="p-4 border border-zinc-800 bg-zinc-950 space-y-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 bg-black border border-zinc-800 p-2.5 text-xs text-white focus:border-[#CCFF00] outline-none"
                />
                <button
                  onClick={submitSetRewardPerCycle}
                  disabled={!rewardPerCycleInput || !isStakingOwner}
                  className="px-6 py-2.5 bg-zinc-900 border border-zinc-700 text-white text-xs font-bold disabled:opacity-30"
                >
                  UPDATE
                </button>
              </div>
            ...
            <div className="p-4 border border-zinc-800 bg-zinc-950 space-y-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 bg-black border border-zinc-800 p-2.5 text-xs text-white focus:border-[#CCFF00] outline-none disabled:opacity-40"
                />
                <button
                  onClick={submitFund}
                  disabled={!fundAmount || !rewardTokenAddress || !isStakingOwner}
                  className="px-6 py-2.5 bg-[#CCFF00] text-black text-xs font-bold disabled:opacity-30"
                >
                  FUND
                </button>
              </div>
