...
> = {
  1: {
    tag: "STANDARD",
    outerClass: "relative border border-zinc-700/70 bg-[#0f1115] overflow-hidden",
    badgeActive: "bg-zinc-100/10 text-zinc-100 border-zinc-400/50",
    badgeInactive: "bg-zinc-900 text-zinc-500 border-zinc-700",
    titleClass: "text-lg font-bold text-white tracking-wide",
    tagClass: "text-[10px] text-zinc-500 tracking-[0.2em]",
    statBoxClass: "p-2 bg-zinc-950 border border-zinc-900",
    statLabelClass: "text-[10px] text-zinc-500 block",
    feeValueClass: "text-white font-bold",
    rewardValueClass: "text-[#CCFF00] font-bold",
    selectAllBtnClass:
      "px-2 py-1 border border-zinc-700 text-[10px] font-bold tracking-widest text-zinc-300 hover:border-zinc-100 hover:text-white transition-colors",
    nftIdleClass: "border-zinc-800 bg-zinc-950 hover:border-zinc-600",
    nftSelectedClass: "border-zinc-100 bg-zinc-900",
    joinBtnClass:
    ...
    claimBtnClass:
      "w-full py-2.5 bg-zinc-900 border border-zinc-700 text-white font-bold text-xs tracking-widest disabled:opacity-30 disabled:cursor-not-allowed hover:border-zinc-100 transition-colors",
    dividerClass: "border-zinc-900",
    registeredLabelClass: "text-[10px] text-zinc-500 tracking-widest",
  },
  2: {
    tag: "ELITE",
    outerClass: "relative border border-amber-500/40 bg-[#0f1115] vip-elite-clip overflow-hidden",
    badgeActive: "bg-amber-500/10 text-amber-400 border-amber-500/50",
    badgeInactive: "bg-zinc-900 text-zinc-500 border-zinc-700",
    titleClass: "text-lg font-bold text-white tracking-wide",
    tagClass: "text-[10px] text-amber-500 tracking-[0.2em]",
    statBoxClass: "p-2 bg-zinc-950 border border-amber-900/30",
    statLabelClass: "text-[10px] text-zinc-500 block",
    feeValueClass: "text-white font-bold",
    rewardValueClass: "text-[#CCFF00] font-bold",
    selectAllBtnClass:
    ...
    nftIdleClass: "border-zinc-800 bg-zinc-950 hover:border-amber-700/60",
    ...
    claimBtnClass:
      "w-full py-2.5 bg-zinc-900 border border-amber-700/50 text-white font-bold text-xs tracking-widest disabled:opacity-30 disabled:cursor-not-allowed hover:border-amber-400 transition-colors",
    dividerClass: "border-amber-900/30",
    registeredLabelClass: "text-[10px] text-amber-500/80 tracking-widest",
  },
  3: {
    tag: "APEX",
    outerClass: "relative border border-[#CCFF00]/50 bg-[#0f1115] vip-apex-glow overflow-hidden",
    badgeActive: "bg-[#CCFF00] text-black border-[#CCFF00] font-bold",
    badgeInactive: "bg-zinc-900 text-zinc-500 border-zinc-700",
    titleClass: "text-lg font-bold text-white tracking-wide drop-shadow-[0_0_10px_rgba(204,255,0,0.35)]",
    tagClass: "text-[10px] text-[#CCFF00] tracking-[0.2em]",
    statBoxClass: "p-2 bg-zinc-950 border border-[#CCFF00]/20",
    statLabelClass: "text-[10px] text-zinc-500 block",
    feeValueClass: "text-white font-bold",
    rewardValueClass: "text-[#CCFF00] font-bold drop-shadow-[0_0_6px_rgba(204,255,0,0.5)]",
    selectAllBtnClass:
      "px-2 py-1 border border-[#CCFF00]/40 text-[10px] font-bold tracking-widest text-[#CCFF00] hover:bg-[#CCFF00]/10 transition-colors",
    nftIdleClass: "border-zinc-800 bg-zinc-950 hover:border-[#CCFF00]/50",
    nftSelectedClass: "border-[#CCFF00] bg-[#CCFF00]/5 shadow-[0_0_10px_rgba(204,255,0,0.25)]",
    joinBtnClass:
      "w-full py-2.5 bg-[#CCFF00] text-black font-bold text-xs tracking-widest disabled:opacity-30 disabled:cursor-not-allowed hover:bg-[#b8e600] transition-colors shadow-[0_0_15px_rgba(204,255,0,0.2)]",
    claimBtnClass:
      "w-full py-2.5 bg-zinc-900 border border-[#CCFF00]/50 text-white font-bold text-xs tracking-widest disabled:opacity-30 disabled:cursor-not-allowed hover:border-[#CCFF00] transition-colors",
    dividerClass: "border-[#CCFF00]/15",
    registeredLabelClass: "text-[10px] text-[#CCFF00]/80 tracking-widest",
  },
};
    ...
    <div className={theme.outerClass}>
      ...
      {cfg.vipLevel === 3 && (
        <>
          ...
          <div className="absolute -right-11 top-4 rotate-45 bg-[#CCFF00] text-black text-[9px] font-bold tracking-widest px-11 py-0.5 shadow-[0_0_10px_rgba(204,255,0,0.4)]">
            TOP TIER
          </div>
        </>
      )}
